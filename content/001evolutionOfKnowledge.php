...
<html>
	...
	<body>
		...
		<?php
				...
				$myContent = file("contentTxt/001evolutionOfKnowledge.txt");
		 ?>
					...
					$contentProbe = substr($myContent[$i], 0, 5);
						...
						if($contentProbe == "<img>"){
							...
							if($imgTracker == true){
								...
								print "<img class='imgRight' src='$imgLink' alt='My Image Obviously Didnt Load'><br>";
							}else{
								$imgTracker = true;
								//we print the img tag with embedded image link assigning it to float left
								print "<img class='imgLeft' src='$imgLink' alt='My Image Obviously Didnt Load'><br>";
							}
