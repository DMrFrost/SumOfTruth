...
<html lang="en">
  ...
  <body>
    <?php
      ...
      if($_POST['submit']){
        ...
        if(!$errors){
          ...
          $subjectToSend = '(ASK)' . $subjectFiltered;
          //basic html message
          $messageToSend = "
          ...
          if(mail($sendTo, $subjectToSend, $messageToSend, $headers)){
            ...
            echo '<script>window.location = "'. 'contactAskHelpSuccess.html' .'";</script>';
          }else{
    ...
    <section class="mailDiv container-fluid" id="askHelp">
      <div class="row">
        <div class="col-xs-12 col-sm-offset-1 col-sm-10">
          <h2>What do you need?  How can I help?</h2><br>
          <div class="mailForm">
            <form method="post">
              <p>Subject</p>
