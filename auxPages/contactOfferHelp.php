...
<html lang="en">
  ...
  <body>
    <?php
      ...
      if($_POST['submit']){
        ...
        if(!$errors){
          ...
          $subjectToSend = '(OFFER)' . $subjectFiltered;
          //basic html message
          $messageToSend = "
          ...
          if(mail($sendTo, $subjectToSend, $messageToSend, $headers)){
            ...
            echo '<script>window.location = "'. 'contactOfferHelpSuccess.html' .'";</script>';
          }else{
    ...
    <section class="mailDiv container-fluid" id="offerHelp">
      <div class="row">
        <div class="col-xs-12 col-sm-offset-1 col-sm-10">
          <h2>Thank you in advance!</h2><br>
          <div class="mailForm">
            <form method="post">
              <p>Subject</p>
